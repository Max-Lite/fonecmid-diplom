...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрокаУслуги Из Услуги Цикл
		Если ТекСтрокаУслуги.Номенклатура = НоменклатураАбонентскаяПлата Тогда
			...
			Движение.Контрагент = Контрагент;
			Движение.Договор = Договор;
			Движение.ВКМ_АбонентскаяПлата = ТекСтрокаУслуги.Сумма;
		КонецЕсли;
		Если ТекСтрокаУслуги.Номенклатура = НоменклатураРаботыСпециалиста Тогда
			...
			Движение.Контрагент = Контрагент;
			Движение.Договор = Договор;
			Движение.ВКМ_РаботаСпециалиста = ТекСтрокаУслуги.Сумма;
		КонецЕсли;
	КонецЦикла;
    //--ВКМ 1CMID_33
...
Процедура ВыполнитьАвтозаполнение() Экспорт
	...
	Если ДанныеДоговора.ВКМ_СуммаАбонентскойПлаты > 0 И ДанныеДоговора.ВКМ_Дата <= КонецМесяца(Дата) И ДанныеДоговора.ВКМ_СрокДействия >= НачалоМесяца(Дата) Тогда
