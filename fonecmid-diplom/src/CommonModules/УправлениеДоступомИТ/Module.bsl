...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//++ВКМ
	// Добавление поставляемых профилей пользователей
	// Профиль "Специалист"
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Идентификатор = "a5fa6779-e243-4669-b890-f5edef1a78cb";
	...
	// Профиль "Менеджер"
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Идентификатор = "a5fa6780-e243-4669-b890-f5edef1a78cb";
	...
	// Профиль "Бухгалтер ИТФирмы"
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Идентификатор = "a5fa6781-e243-4669-b890-f5edef1a78cb";
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Идентификатор = "a5fa6782-e243-4669-b890-f5edef1a78cb";
